...
# ========== PASSWORTSCHUTZ ==========
def check_password():
    """Einfacher Passwortschutz mit Streamlit Secrets"""
...
if check_password():
    ...
    for _, row in df.iterrows():
        ...
        try:
            ...
            results.append([symbol, shares, f"{gross_div:.2f} {currency}", f"{net_div_eur:.2f} EUR"])
    ...
    if results:
        ...
        fig, ax = plt.subplots()
        ax.bar(df_results["Symbol"], df_results["Netto (EUR)"].astype(float))
